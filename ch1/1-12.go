...
//var palette = []color.Color{red, random, green, color.Black, red, blue}
var palette = []color.Color{random1, random2}
...
var c = config{cycles: 5, size: 100, nframes: 64, delay: 8, res: 0.001}
...
func parseQuery(r *http.Request) {
	...
	fmt.Printf("%+v\n", values)
	fmt.Printf("%+v\n", values["cycles"][0])
	c.cycles, _ = strconv.Atoi(values["cycles"][0])
	return
}
